        ...
        <section className="minimal-results-list" aria-labelledby="published-results-title">
          ...
          <a className="result-report-entry" href={researchUrl}>
            <div className="result-report-main">
              ...
              <h3>深度研究</h3><p>研究插件，能交出完整报告吗？</p><span className="result-report-link">查看完整报告 <span aria-hidden="true">→</span></span>
            </div>
          ...
          <a className="result-report-entry" href="/results/memory/locomo20-2026-08-28">
            ...
            <div className="result-report-finding">
              ...
              <small>{memoryBenchmark.pluginCount} 个 Agent · 每组 {memoryBenchmark.sampleSizePerTrack} 道题</small>
            </div>
          </a>
        </section>
