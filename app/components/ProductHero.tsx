  ...
  return (
    <section className="homepage-hero" id="about" aria-labelledby="home-hero-title">
      <div className="homepage-hero-inner">
        ...
        <div className="homepage-evidence" aria-label="最新评测：跨会话记忆">
          <div className="homepage-evidence-shell">
            <EvaluationDossier
              className="homepage-dossier"
              reportHref="/dsheval/results/memory/locomo20-2026-08-28"
            />
          </div>
        </div>
      </div>
