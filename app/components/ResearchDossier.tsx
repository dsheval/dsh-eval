...
export default function ResearchDossier() {
  return <article className="dossier homepage-dossier">
    ...
    <div className="dossier-task"><span className="field-label">最新评测 · 深度研究</span><p data-site-copy="body">研究插件，能交出完整报告吗？</p></div>
    <div className="dossier-verdict">
      <div><span className="field-label">本轮观察</span><h2>仅 {researchLongformPassCount} 个插件</h2><p data-site-copy="note">通过了其中一道报告题</p></div>
      <dl className="confidence-block"><div><dt>参评插件</dt><dd>{researchPluginCount} 个</dd></div><div><dt>报告题目</dt><dd>2 道</dd></div></dl>
    </div>
    <p className="dossier-reason" data-site-copy="note">dsh-search-boost 通过了金融报告题；其余插件的两道报告题均为部分完成。</p>
